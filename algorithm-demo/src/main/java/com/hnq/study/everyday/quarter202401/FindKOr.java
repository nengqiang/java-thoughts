 ...
 * @author henengqiang
 * @date 2024/3/6
 * @see <a href="https://leetcode.cn/problems/find-the-k-or-of-an-array/?envType=daily-question&envId=2024-03-06">链接</a>
 */
public class FindKOr {

    public static void main(String[] args) {
        FindKOr f = new FindKOr();
        int[] n1 = {2, 12, 1, 11, 4, 5};
        System.out.println(f.findKOr(n1, 6));
    }
