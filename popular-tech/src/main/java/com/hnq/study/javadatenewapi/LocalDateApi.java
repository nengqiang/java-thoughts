...
/**
 *  不同于 Calendar 既能处理日期又能处理时间，java.time 的新式 API 分离开日期和时间，用单独的类进行处理。
...
public class LocalDateApi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("当前年是否闰年： " + localDate.isLeapYear());
        System.out.println("当前年's days: " + localDate.lengthOfYear());
